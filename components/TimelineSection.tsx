      ...
      <div className="relative space-y-8 before:absolute before:bottom-4 before:left-[0.45rem] before:top-4 before:w-px before:bg-zinc-300 dark:before:bg-zinc-700">
         {entries.map((entry) => (
            <article
               ...
               data-timeline-card
               className="relative pl-8 opacity-0"
            >
               <span className="absolute left-0 top-2 size-2 rounded-full bg-emerald-500 ring-4 ring-white dark:bg-violet-400 dark:ring-black" />
               <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 sm:p-8">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                     <div>
                        ...
                        <p className="mt-1 text-emerald-600 dark:text-violet-400">
                           {entry.role[lang]}
                        </p>
                     </div>
                  ...
                  <ul className="mt-6 flex flex-wrap gap-2" aria-label="Technologies and skills">
                     {entry.tags.map((tag) => (
                        <li
                           key={tag}
      ...
      >
         <div className="mx-auto w-full max-w-6xl">
            ...
            <h2 className="mt-5 max-w-3xl text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
               {lang === 'es' ? 'Experiencia y formación' : 'Experience and education'}
            </h2>
            <div className="mt-14 space-y-16">
               <div>
                  ...
                  <TimelineGroup entries={timelineData.experience} lang={lang} />
               </div>
               <div>
                  <h3 className="mb-8 text-xl font-semibold text-zinc-700 dark:text-zinc-300">
